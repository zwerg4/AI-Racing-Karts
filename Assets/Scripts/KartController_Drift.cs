...
public class KartController_Drift : MonoBehaviour
{
  ...
  public void DriftStart(float driftSignal)
  {
    drifting = true;
    driftDirection = (int) driftSignal;
